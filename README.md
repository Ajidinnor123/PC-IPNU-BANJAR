...
<link rel="preconnect" href="https://docs.google.com/forms/d/e/1FAIpQLSfidgp2B1GfwSLx6bisRCqPV9ahq5_HxRP2XdrvxcfD-6ApOA/viewform?embedded=true">
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  body{
    ...
    color:var(--ink);
    font-family:'Plus Banjar Sans', sans-serif;
  ...
  .hero{
    ...
    overflow:hidden;
    background:
      radial-gradient(1200px 600px at 85% -10%, rgba(199,154,43,0.14), transparent 60%),
  ...
  .person-card.local{border-color: rgba(199,154,43,0.5);}
  ...
  .person-card.local .local-tag{display:inline-block;}
  .person-card.local .avatar{margin-top:14px;}
  ...
  <div class="hero-inner">
    ...
    <div class="hero-visual">
      ...
      <div class="diamond-caption">
        <span class="eyebrow">Periode 2024–2026</span>
  ...
  <div class="block-inner">
    <div class="section-head">
      <div>
        ...
        <p>Susunan Pimpinan Cabang IPNU Kabupaten Banjar masa khidmat 2024–2026. Nama di bawah adalah placeholder — silakan disesuaikan dengan data pengurus yang sah.</p>
      </div>
    </div>
    ...
    <div class="people-grid" id="grid-pimpinan-harian" data-tier="Pimpinan Harian">
      ...
      <div class="person-card"><div class="avatar">W1</div><h4>Nama Pengurus</h4><div class="role">Wakil Ketua I</div></div>
      <div class="person-card"><div class="avatar">W2</div><h4>Nama Pengurus</h4><div class="role">Wakil Ketua II</div></div>
      <div class="person-card"><div class="avatar">SU</div><h4>MAULANA ALKAUSAR</h4><div class="role">Sekretaris Umum</div></div>
      <div class="person-card"><div class="avatar">WS</div><h4>Nama Pengurus</h4><div class="role">Wakil Sekretaris</div></div>
      <div class="person-card"><div class="avatar">BU</div><h4>Nama Pengurus</h4><div class="role">Bendahara Umum</div></div>
      <div class="person-card"><div class="avatar">WB</div><h4>Nama Pengurus</h4><div class="role">Wakil Bendahara</div></div>
    </div>
...
<div class="modal-overlay" id="anggota-modal-overlay">
  <div class="modal-box">
    ...
    <p class="form-desc">Anggota baru akan langsung tampil di kelompok yang dipilih. Data tersimpan di browser perangkat ini — untuk tampil ke semua pengunjung, salin datanya (tombol di bawah) lalu kirim ke admin untuk dimasukkan ke kode halaman.</p>
  ...
  <div class="block-inner">
    ...
    <div class="service-grid">
      <div class="service-card">
        ...
        <a href="https://wa.me/6283853209822" target="_blank" rel="noopener" class="btn btn-ghost btn-sm">Hubungi via WhatsApp</a>
      </div>
      <div class="service-card">
        <div class="service-icon"></div>
...
<div class="modal-overlay" id="berita-modal-overlay">
  <div class="modal-box">
    ...
    <p class="form-desc">Berita akan langsung tampil di kartu berita halaman ini. Data tersimpan di browser perangkat Anda — untuk tampil ke semua pengunjung, salin datanya (tombol di bawah) lalu tambahkan ke Google Sheet atau kirim ke admin.</p>
      ...
      <div class="field-row">
        ...
        <div class="field">
          ...
          <select id="nb-kategori" required>
            ...
            <option value="Kabar Ranting">Kabar Ranting</option>
...
<script>
  // ================================================================
  // STRUKTUR: TAMBAH ANGGOTA (tersimpan lokal di browser)
  // ================================================================
  ...
  function buildPersonCardEl(item){
    const card = document.createElement('div');
    card.className = 'person-card local';
    card.dataset.localId = item.id;
    card.innerHTML =
      '<span class="local-tag">Baru</span>' +
      '<button type="button" class="remove-btn" title="Hapus anggota ini">&times;</button>' +
      '<div class="avatar">' + escapeHTMLAnggota(item.inisial) + '</div>' +
  ...
  function renderLocalAnggota(){
    // bersihkan kartu lokal lama di semua grid
    document.querySelectorAll('.person-card.local').forEach(function(el){ el.remove(); });

    const list = loadLocalAnggota();
    list.forEach(function(item){
      const gridId = TIER_GRID_MAP[item.tier];
      const grid = gridId ? document.getElementById(gridId) : null;
      if(grid){
        const addBtn = grid.querySelector('.add-person-card');
        const card = buildPersonCardEl(item);
